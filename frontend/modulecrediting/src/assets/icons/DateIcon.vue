...
<template>
  <svg v-if="type==='creation'" class="date-icon" aria-label="Erstelldatum"
  ...
  <svg v-else-if="type==='lastEdited'" class="date-icon" aria-label="Datum des letzten Bearbeitens"
       viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <svg v-else-if="type==='decision'" class="date-icon" aria-label="Beschlussdatum"
       viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M1.5 8.5V22.5H25V8.5M1.5 8.5H25M1.5 8.5V3.5H8M25 8.5V3.5H19M8 3.5H19M8 3.5V0M8 3.5V6M19 3.5V0M19 3.5V6" stroke="#262A31" stroke-width="2"/>
