...
<template>
    <svg v-if="type==='upload'" class="file-icon" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<title>{{ $t('FileIcon.upload') }}</title>
</svg>

<svg v-else class="file-icon" viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg">
